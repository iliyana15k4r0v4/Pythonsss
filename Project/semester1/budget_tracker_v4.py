...
def show_results(weekly_income, rent, groceries, transport, ent_costs,descriptions,total_expences,money_left):
    ...
    print("Your notes on this weeks spendings: \n",descriptions)
    print("---------------------------")
...
while True:
    ...
    if choice == 1:
        ...
        show_results(weelkly_income,rent,groceries,transport,ent_costs,descriptions,total_expenses,money_left)
